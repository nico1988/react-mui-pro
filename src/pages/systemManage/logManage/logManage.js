...
const TABLE_HEAD = [
  ...
  { id: 'name', label: '操作模块', alignRight: false },
  { id: 'name', label: '操作详情', alignRight: false },
  { id: 'name', label: '操作员账号', alignRight: false },
  { id: 'name', label: '操作员姓名', alignRight: false },
  { id: 'name', label: '操作状态', alignRight: false },
  { id: 'name', label: '操作IP', alignRight: false },
  { id: 'name', label: '操作时间', alignRight: false },
  { id: '' },
];
