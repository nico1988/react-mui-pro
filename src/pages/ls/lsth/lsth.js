...
const TABLE_HEAD = [
  { id: 'name', label: '供应商', alignRight: false },
  { id: 'name', label: '单据编号', alignRight: false },
  { id: 'name', label: '商品名称', alignRight: false },
  { id: 'name', label: '数量', alignRight: false },
  { id: 'name', label: '金额', alignRight: false },
  { id: 'name', label: '单据日期', alignRight: false },
  { id: 'name', label: '操作员', alignRight: false },
  { id: 'name', label: '状态', alignRight: false },
  { id: 'name', label: '操作', alignRight: false },
  { id: '' },
];

// ----------------------------------------------------------------------

export default function LingShouReturn() {
