...
const TABLE_HEAD = [
  ...
  { id: 'name', label: '仓库名称', alignRight: false },
  { id: 'name', label: '仓库地址', alignRight: false },
  { id: 'name', label: '库存总数', alignRight: false },
  { id: 'name', label: '货架数量', alignRight: false },
  { id: 'name', label: '负责人', alignRight: false },
  { id: 'name', label: '备注', alignRight: false },
  { id: 'name', label: '操作', alignRight: false },
  { id: '' },
];
// ----------------------------------------------------------------------

export default function DiaoBoInfo() {
